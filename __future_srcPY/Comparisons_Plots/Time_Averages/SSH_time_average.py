...
if np.size(LRvardims) == 3:
    LRvar = np.mean(LRdata.variables[LRvarname][1:maxTime, ::-1, :], axis=0)
    LUvar = np.mean(LUdata.variables[LRvarname][1:maxTime, ::-1, :], axis=0)
