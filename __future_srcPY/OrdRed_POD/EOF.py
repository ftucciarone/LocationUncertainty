...
out_dir = work_dir + "/data/POD_Output"
...
infile = data_dir + "/" + prefix + "_CsGrained_r3_" + suffix + ".nc"
...
# Save output data
# ----------------
print("Preparing output file: ", out_dir + "/" + IPT + "/spmXXX" + suffix + "_" + IPT + ".nc")
for dim in range(3):
    outfile = out_dir + "/" + IPT + "/" + prefix + "spm" + sfx[dim] + suffix + "_" + IPT +".nc"
