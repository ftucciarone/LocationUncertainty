MODULE tlugss
   ...
   !
   ! [ ]
   INTEGER(i4), PUBLIC                                      :: nn_tlu_hsiz = 4 !> @public size of halo
   INTEGER(i4), PUBLIC                                      :: nn_tlu_hbox = 2 !> @public 
   ! [ ]   
   !
   ! [tlu_spnoise]
   REAL(wp)                                                 :: amp = 0.012500_wp    !> @private amplitude in m/s
   !
   ...
   TYPE(filter)                                             :: gss_3by3
   TYPE(filter)                                             :: gss_5by5
   TYPE(filter)                                             :: gss_7by7
...
CONTAINS
   ...
   SUBROUTINE tlu_init_gss
      ...
      ! Initialize filter
      !
      CALL gss_3by3%kern_init( "gau", 1 )
      CALL gss_5by5%kern_init( "gau", 2 )
      CALL gss_7by7%kern_init( "gau", 3 )
   ...
   SUBROUTINE gen_white_noise( kt )
      ...
      u_wht = 0._wp
      v_wht = 0._wp
      CALL gss_3by3%kern_apply_2fld(  urnd, vrnd, u_wht, v_wht, .false. )
      CALL gss_5by5%kern_apply_2fld(  4._wp*urnd, 4._wp*vrnd, u_wht, v_wht, .true. )
      CALL gss_7by7%kern_apply_2fld(  8._wp*urnd, 8._wp*vrnd, u_wht, v_wht, .true. )
      !
