...
CONTAINS
   ...
   SUBROUTINE read_vel_mod( )
      ...
      DO jm = 1,nn_tlu_nmod_r
         ...
         !
         dmd_rxmd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_rxmd_r(:,:,m_idx + 1 : m_idx + jpk ) * umask * val_r * val_g
         dmd_rymd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_rymd_r(:,:,m_idx + 1 : m_idx + jpk ) * vmask * val_r * val_g
         dmd_rzmd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_rzmd_r(:,:,m_idx + 1 : m_idx + jpk ) * wmask * val_r * 0._wp
         dmd_ixmd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_ixmd_r(:,:,m_idx + 1 : m_idx + jpk ) * umask * val_r * val_g
         dmd_iymd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_iymd_r(:,:,m_idx + 1 : m_idx + jpk ) * vmask * val_r * val_g
         dmd_izmd_r(:,:,m_idx + 1 : m_idx + jpk ) = dmd_izmd_r(:,:,m_idx + 1 : m_idx + jpk ) * wmask * val_r * 0._wp
         !
      END DO
      !
      ...
      IF (ln_tlu_bia) THEN
         ...
         DO jm = 1,nn_tlu_nmod_c
            ...
            !
            dmd_rxmd_c(:,:,m_idx + 1 : m_idx + jpk ) = dmd_rxmd_c(:,:,m_idx + 1 : m_idx + jpk ) * umask * val_c * val_g
            dmd_rymd_c(:,:,m_idx + 1 : m_idx + jpk ) = dmd_rymd_c(:,:,m_idx + 1 : m_idx + jpk ) * vmask * val_c * val_g
            dmd_ixmd_c(:,:,m_idx + 1 : m_idx + jpk ) = dmd_ixmd_c(:,:,m_idx + 1 : m_idx + jpk ) * umask * val_c * val_g
            dmd_iymd_c(:,:,m_idx + 1 : m_idx + jpk ) = dmd_iymd_c(:,:,m_idx + 1 : m_idx + jpk ) * vmask * val_c * val_g
            !
         END DO
         !
         ! Read frequency vector
         ...
         !
         umean = umean * umask * val_g * 0.30_wp ! split dmd: 1.5, regular dmd 0.25
         vmean = vmean * vmask * val_g * 0.30_wp
         !
      END IF
      !
      wnoi = 0._wp
