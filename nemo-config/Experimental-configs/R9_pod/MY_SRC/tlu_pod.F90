...
CONTAINS
   ...
   SUBROUTINE read_vel_mod( )
      ...
      DO jm = 1, nn_tlu_nmod
         ...
         !
         !
         pod_xmd(:,:,m_idx + 1 : m_idx + jpk ) = zwa1 * umask * val * 10._wp ! old was 6
         pod_ymd(:,:,m_idx + 1 : m_idx + jpk ) = zwa2 * vmask * val * 10._wp
         pod_zmd(:,:,m_idx + 1 : m_idx + jpk ) = zwa3 * wmask * val * 10._wp
         !
      ENDDO
      !
