...
CONTAINS
   ...
   SUBROUTINE read_vel_mod( )
      ...
      DO jm = 1, nn_tlu_nmod
         ...
         !
         !
         pod_xmd(:,:,m_idx + 1 : m_idx + jpk ) = zwa1 * umask * val * 2._wp ! old was 2
         pod_ymd(:,:,m_idx + 1 : m_idx + jpk ) = zwa2 * vmask * val * 2._wp
         pod_zmd(:,:,m_idx + 1 : m_idx + jpk ) = zwa3 * wmask * val * 2._wp
         !
      ENDDO
      !
      ...
      IF (ln_tlu_bia) THEN
         ...
         !
         pod_xav = pod_yav * 0.03_wp * umask * val ! old was 0.025
         pod_yav = pod_xav * 0.03_wp * vmask * val
         !
      END IF
      !
      ! Close netCDF files
