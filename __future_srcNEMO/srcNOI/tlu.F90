...
MODULE tlu
   ...
   LOGICAL,     PUBLIC                                        :: ln_tlu_svd = .FALSE.    !< @public Switch for Pseudo-Observation model
   !
   ! [tlu_noise]
   ...
   !
   ! [tlu_Schmidt]
   REAL(wp),    PUBLIC, PARAMETER ::   Sc_T = 10._wp   ! Schmidt number for Temperature
   REAL(wp),    PUBLIC, PARAMETER ::   Sc_S = 100._wp   ! Schmidt number for Salinity
   ! [tlu_Schmidt]
   !
   ! [tlu_MKE_prcntg]
...
CONTAINS
   ...
   SUBROUTINE tlu_init
      ...
      !
      NAMELIST/namtlu/ ln_tlu, ln_pyp, ln_tlu_bia, ln_tlu_pod, ln_tlu_dmd, ln_tlu_svd, MKE_prcntg
      !!------------------------------------------------------------------------
      !
      ...
      IF (lwp) THEN
         ...
         WRITE(numout,*) ''
         WRITE(numout,*) '        Percentage of MKE vs TKE to inject   MKE_prcntg = ', MKE_prcntg
         WRITE(numout,*)
         ...
         WRITE(numout,*) '        Data-Free Pseudo-Observation Model   ln_tlu_svd = ', ln_tlu_svd
      END IF
      !
